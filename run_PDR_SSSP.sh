...
program_Dir="./PDR_SSSP_Directed.exe"
program_Udir="./PDR_SSSP_Undirected.exe"

echo "Running PDR_DS SSSP Undirected Networks: --------------------------> "
...
echo "Running PDR_SSSP for Directed Networks: -------> "
# Loop through each argument and run the program
